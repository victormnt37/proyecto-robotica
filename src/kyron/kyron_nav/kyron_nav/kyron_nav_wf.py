...
class WaypointFollower(Node):
    ...
    def define_waypoints(self):
        ...
        puntos = [
            ...
            (-3.6588544845581055, 5.922541618347168),
            (-2.537137508392334, 7.420501708984375),
            (-1.4154205322265625, 8.918461799621582),
            (-0.293703556060791, 10.416421890258789),
            (0.8280134201049805, 11.914381980895996),
            (2.1817116737365723, 13.7138671875)
        ]   
